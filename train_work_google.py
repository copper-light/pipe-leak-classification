...
class SoundDataset(Dataset):
    ...
    def _cache(self, index):
        ...
        specgram3 = torchaudio.transforms.MelSpectrogram(sample_rate=sample, n_fft=1024, n_mels=128)(waveform)
...
if __name__ == "__main__":
    ...
    for sub in train_set_list:
        loader = torch.utils.data.DataLoader(sub, batch_size = 128, shuffle = True, worker_init_fn=seed_worker, generator=g, num_workers=0) # resnet18 best : 256  , generator=g
