...
class SoundDataset(Dataset):
    ...
    def _cache(self, index):
        ...
        n_mels = 224
        sample_rate = 22050
        mel_spec = torchaudio.transforms.MelSpectrogram(n_fft=n_fft, hop_length= hop_length, win_length=win_length, n_mels=n_mels)

        specgram3 = mel_spec(waveform)
        ...
        specgram4 = torchaudio.transforms.MFCC(sample_rate=sample, n_mfcc=64)(waveform)
        ...
        specgram5 = spec(torch.tensor(y_perc))
        ...
        specgram6 = spec(torch.tensor(y_harm))
        ...
        specgram = torch.stack([specgram1, specgram2, specgram3, specgram4, specgram5, specgram6], dim=0)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--seed', dest='random_seed', type=int, default=45) # -- 16 best
